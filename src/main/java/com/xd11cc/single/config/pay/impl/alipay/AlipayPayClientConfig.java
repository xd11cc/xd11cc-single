...
/**
 * @author xd11cc
 * @date 2026-06-08 10:18:31
 * @description 支付宝的 PayClientConfig 实现类
 *              属性主要来自{@link com.alipay.api.AlipayClient} 的必要属性
 */
@Data
public class AlipayPayClientConfig implements PayClientConfig {
     ...
     * 开放平台上创建的应用ID
     */
    @NotBlank(message = "开放平台上创建的应用 ID 不能为空", groups = {ModePublicKey.class, ModeCertificate.class})
     ...
     * 指定根证书内容字符串
     */
    @NotBlank(message = "指定根证书内容不能为空", groups = {ModeCertificate.class})
