...
import com.xd11cc.single.enums.PayRefundStatusEnum;
import lombok.Data;
...
public class PayRefundRespDTO {
    ...
    /**
     * 退款状态
     * 枚举 {@link com.xd11cc.single.enums.PayRefundStatusEnum}
     */
    ...
    /**
     * 调用渠道的错误码
     * 注意：这里返回的是业务异常，而不是系统异常
     * 如果是系统异常，则会抛出 {@link com.xd11cc.single.config.exception.PayClientException}
     */
    ...
    public static PayRefundRespDTO failureOf(String outRefundNo, Object rawData){
        return failureOf(null, null, outRefundNo, rawData);
    }
